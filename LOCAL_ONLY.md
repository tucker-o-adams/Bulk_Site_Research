...
Generated 2026-09-22T01:09+00:00 by `scripts/local_only_inventory.py` from `git ls-files --others --ignored`. Re-run it after any batch or fetch. These files exist only in this working copy; back up the ones marked worth archiving by some other means.

**Total: 13727 files, 1.18 GB**
